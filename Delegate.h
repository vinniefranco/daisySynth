 ...
 *
 *	License:
 *	As stated explicitly in the article linked above, this code is released
 *into the public domain and may be used for any purpose.
 *
 */
...
//				  * Added delegate::empty() to test if invocation is
//safe (Thanks Neville Franks).
//				  * Now tested on VS 2005 Express Beta, PGI C++
// 24-Dec-04 1.4  * Added DelegateMemento, to allow collections of disparate
// delegates.
//				  * <,>,<=,>= comparison operators to allow storage in
//ordered containers.
...
//				  * Now compiles without warnings on _any_ supported
//compiler, including BCC 5.5.1
...
//				  * Bugfix for Metrowerks: empty() was buggy because a
//valid MFP can be 0 on MWCC!
//				  * More optimal assignment,== and != operators for
//static function pointers.
//
// 19-May-09 1.5a Patrick Hogan:
//				  * Bundled with Signals.h for signals and slots
//library
...
// cast to
//	   (char *) first to ensure that the correct number of *bytes* are
//added.
//
////////////////////////////////////////////////////////////////////////////////
//						Helper templates
...
//				   where it never returns void (returns DefaultVoid
//instead).
...
// N=0
template <class RetType = detail::DefaultVoid> class Delegate0 {
private:
...
// N=1
template <class Param1, class RetType = detail::DefaultVoid> class Delegate1 {
private:
  typedef typename detail::DefaultVoidToVoid<RetType>::type DesiredRetType;
...
public:
  ...
  // Static functions. We convert them into a member function call.
  // This constructor also provides implicit conversion
  Delegate3(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2,
                                               Param3 p3)) {
    Bind(function_to_bind);
  }
  // for efficiency, prevent creation of a temporary
...
public:
  ...
  // Static functions. We convert them into a member function call.
  // This constructor also provides implicit conversion
  Delegate4(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
                                               Param4 p4)) {
    Bind(function_to_bind);
  }
  // for efficiency, prevent creation of a temporary
...
public:
  ...
  // Static functions. We convert them into a member function call.
  // This constructor also provides implicit conversion
  Delegate5(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
                                               Param4 p4, Param5 p5)) {
    Bind(function_to_bind);
  }
  // for efficiency, prevent creation of a temporary
...
public:
  ...
  // Static functions. We convert them into a member function call.
  // This constructor also provides implicit conversion
  Delegate6(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
                                               Param4 p4, Param5 p5,
                                               Param6 p6)) {
    Bind(function_to_bind);
  }
...
public:
  ...
  // Binding to non-const member functions
  template <class X, class Y>
  Delegate7(Y *pthis, DesiredRetType (X::*function_to_bind)(
  ...
  // Binding to const member functions.
  template <class X, class Y>
  Delegate7(const Y *pthis, DesiredRetType (X::*function_to_bind)(
                                Param1 p1, Param2 p2, Param3 p3, Param4 p4,
  ...
  // Static functions. We convert them into a member function call.
  // This constructor also provides implicit conversion
  Delegate7(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
                                               Param4 p4, Param5 p5, Param6 p6,
                                               Param7 p7)) {
    Bind(function_to_bind);
  }
...
public:
  ...
  // Binding to non-const member functions
  template <class X, class Y>
  Delegate8(Y *pthis, DesiredRetType (X::*function_to_bind)(
                          Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5,
  ...
  // Static functions. We convert them into a member function call.
  // This constructor also provides implicit conversion
  Delegate8(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
                                               Param4 p4, Param5 p5, Param6 p6,
                                               Param7 p7, Param8 p8)) {
    Bind(function_to_bind);
  }
...
public:
  ...
  template <class X, class Y>
  Delegate(const Y *pthis, R (X::*function_to_bind)(Param1 p1, Param2 p2,
                                                    Param3 p3, Param4 p4) const)
      : BaseType(pthis, function_to_bind) {}
...
class Delegate<R(Param1, Param2, Param3, Param4, Param5, Param6, Param7)>
    ...
    : public Delegate7<Param1, Param2, Param3, Param4, Param5, Param6, Param7,
                       R> {
public:
  // Make using the base type a bit easier via typedef.
  typedef Delegate7<Param1, Param2, Param3, Param4, Param5, Param6, Param7, R>
      BaseType;
...
//  ) > instead of Delegate8 < Param1, Param2, Param3, Param4, Param5, Param6,
//  Param7, Param8, R >
template <typename R, class Param1, class Param2, class Param3, class Param4,
...
class Delegate<R(Param1, Param2, Param3, Param4, Param5, Param6, Param7,
    ...
    : public Delegate8<Param1, Param2, Param3, Param4, Param5, Param6, Param7,
                       Param8, R> {
public:
  // Make using the base type a bit easier via typedef.
...
Delegate1<Param1, FASTDLGT_RETTYPE>
...
Delegate2<Param1, Param2, FASTDLGT_RETTYPE>
...
template <class X, class Y, class Param1, class Param2, class Param3,
          class RetType>
Delegate3<Param1, Param2, Param3, FASTDLGT_RETTYPE>
...
Delegate4<Param1, Param2, Param3, Param4, FASTDLGT_RETTYPE>
MakeDelegate(Y *x,
...
Delegate5<Param1, Param2, Param3, Param4, Param5, FASTDLGT_RETTYPE>
MakeDelegate(Y *x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3,
                                      Param4 p4, Param5 p5)) {
  return Delegate5<Param1, Param2, Param3, Param4, Param5, FASTDLGT_RETTYPE>(
      x, func);
}
...
Delegate6<Param1, Param2, Param3, Param4, Param5, Param6, FASTDLGT_RETTYPE>
MakeDelegate(Y *x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3,
                                      Param4 p4, Param5 p5, Param6 p6)) {
  return Delegate6<Param1, Param2, Param3, Param4, Param5, Param6,
...
Delegate7<Param1, Param2, Param3, Param4, Param5, Param6, Param7,
          FASTDLGT_RETTYPE>
MakeDelegate(Y *x,
             RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4,
                                Param5 p5, Param6 p6, Param7 p7)) {
  return Delegate7<Param1, Param2, Param3, Param4, Param5, Param6, Param7,
                   FASTDLGT_RETTYPE>(x, func);
}
...
template <class X, class Y, class Param1, class Param2, class Param3,
          ...
          class RetType>
Delegate8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8,
          FASTDLGT_RETTYPE>
MakeDelegate(Y *x,
             RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4,
                                Param5 p5, Param6 p6, Param7 p7, Param8 p8)) {
  return Delegate8<Param1, Param2, Param3, Param4, Param5, Param6, Param7,
